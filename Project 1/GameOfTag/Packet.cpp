...
void Packet::append(const StartGameData& t_startData)
{
	append((const char*)&t_startData, sizeof(StartGameData));
}

void Packet::append(const EndGameData& t_endData)
{
	append((const char*)&t_endData, sizeof(EndGameData));
}
